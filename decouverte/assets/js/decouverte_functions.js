...
var savedPageNumber = parseInt(window.localStorage.getItem("max_page_decouverte"));
...
function enable_next() {
    ...
    window.localStorage.setItem("max_page_decouverte", Math.max(currentPageNumber + 1, savedPageNumber));
}
